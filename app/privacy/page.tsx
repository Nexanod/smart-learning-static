  ...
  return (
    <LegalPageLayout label='LEGAL' title='Privacy Policy'>
      <p className='text-stone-600'>
        Last updated: February 2026. Smart Learning Systems (&quot;we&quot;,
      ...
      <div>
        ...
        <p className='text-stone-600 mb-4'>
          We collect information you provide directly (e.g. account details,
          institution name, contact information), usage data (e.g. feature
          usage, logs), and technical data (e.g. IP address, device type,
          browser) necessary to operate and improve our services.
        </p>
      </div>
      ...
      <div>
        ...
        <p className='text-stone-600 mb-4'>
          We use collected information to deliver, maintain, and improve our
          services; to communicate with you; to ensure security and prevent
          fraud; and to comply with legal obligations. We do not sell your
      ...
      <div>
        ...
        <p className='text-stone-600 mb-4'>
          ...
          described in this policy or as required by law. We implement
      ...
      <div>
        ...
        <p className='text-stone-600 mb-4'>
          ...
          restrict certain processing. Contact us at the details below to
