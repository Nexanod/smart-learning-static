        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl font-bold mb-6 leading-tight">
              Simple, <span className="bg-gradient-to-r from-blue-600 via-sky-500 to-blue-700 bg-clip-text text-transparent">Transparent</span> Pricing
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto mb-16">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <Card className={`h-full transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${plan.popular ? 'border-sky-600 border-2 shadow-2xl' : 'border-2 hover:border-blue-500/30'}`}>
                    ...
                    <ul className="space-y-3">
                      {plan.features.map((feature, fIndex) => (
                        <motion.li 
                          ...
                          transition={{ duration: 0.5, delay: 0.1 + (fIndex * 0.05) }}
                        >
                          {feature.included ? (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Need specific modules only? Subscribe to individual modules separately
            </p>
          </motion.div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border">
                        ...
                        <th className="text-center p-6 font-semibold bg-sky-500/5">Professional</th>
                    ...
                    <tbody>
                      {modules.map((module, index) => (
                        ...
                        >
                          ...
                          <td className="p-6 text-center text-muted-foreground">{module.starter}</td>
                          <td className="p-6 text-center bg-sky-500/5 font-semibold text-sky-600">{module.professional}</td>
                          <td className="p-6 text-center text-muted-foreground">{module.enterprise}</td>
                        </motion.tr>
                      ))}
                    </tbody>
                  </table>
