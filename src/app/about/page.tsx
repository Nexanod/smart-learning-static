  ...
  const milestones = [
    {
      ...
      description: 'Started with a vision to modernize education',
    },
    {
      year: '2021',
    ...
    },
    {
      ...
      description: 'Launched AI-powered paper generation',
    },
    {
      year: '2023',
  ...
  const values = [
    {
      ...
      title: 'Our Mission',
      description:
        'To eliminate physical labor in education and move everything to a fully digital, intelligent system that empowers educators and institutions.',
    },
    {
      icon: Eye,
      title: 'Our Vision',
      description:
        'A world where every educational institution has access to cutting-edge technology that makes administration effortless and learning more effective.',
    },
    {
      icon: Award,
      title: 'Our Commitment',
      description:
        "We're committed to continuous innovation, exceptional customer service, and building tools that make a real difference in education.",
    },
  ];
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
          ...
          >
            ...
            <p className='text-xl sm:text-2xl text-muted-foreground leading-relaxed mb-8'>
              We&apos;re on a mission to modernize education systems worldwide
              by eliminating physical labor and moving everything to a fully
              digital, AI-powered intelligent platform.
            </p>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto'>
            ...
            >
              ...
              <div className='space-y-4 text-lg text-muted-foreground leading-relaxed'>
                <p>
                  Smart Learning was born from a simple observation: educational
                  institutions were spending countless hours on administrative
                  tasks that could be automated.
                </p>
                <p>
                  Our founders, experienced educators and technologists, saw
                  teachers staying late to create exam papers, administrators
                  manually tracking attendance, and schools struggling with
                  student communication.
                </p>
                <p>
                  We knew there had to be a better way. So we built Smart
                  Learning - a comprehensive B2B platform that eliminates
                  physical labor and brings education administration into the
                  digital age.
                </p>
                <p>
                  Today, we&apos;re proud to serve over 500 institutions across
                  15 countries, helping them save time, reduce costs, and focus
                  on what matters most: quality education.
                </p>
              </div>
            </motion.div>
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl mb-8 opacity-90 max-w-2xl mx-auto'>
              Be part of the education revolution. Transform your institution
              today.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Button
