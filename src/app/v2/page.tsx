...
import { ArrowRight, Sparkles, Users, Brain, MessageSquare, BarChart3, Calendar, Zap } from "lucide-react";
import "./globals.css";
    ...
    <div className="min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Modernizing Education with AI</span>
            </motion.div>
          ...
          >
            Eliminate physical labor and transform your institution with a fully digital,
            AI-powered education platform. From paper generation to student management—all in one place.
          </motion.p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Our B2B platform provides each school or company with a customizable website
              on its own subdomain. Brand it your way, configure features to match your needs,
              and scale effortlessly.
            </p>
            <div className="flex flex-wrap gap-6 justify-center items-center">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl px-6 py-4">
                <p className="text-3xl font-bold gradient-text">Custom Domains</p>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl px-6 py-4">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Ready to Transform Your <span className="gradient-text">Education System?</span>
            </h2>
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Join the future of education. Get started with Smart Learning today.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-2">
              <h3 className="text-2xl font-bold gradient-text mb-3">Smart Learning</h3>
