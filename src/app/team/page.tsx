  ...
  const values = [
    {
      ...
      description: "We're committed to making quality education accessible and efficient for all institutions."
    },
    {
      icon: Award,
      title: "Excellence",
      description: "We maintain the highest standards in our products and customer service."
    },
    {
      icon: Heart,
      title: "Impact-Focused",
      description: "Every feature we build aims to improve the lives of educators and students."
    },
    {
      icon: Users,
      title: "Collaboration",
      description: "We work closely with educators to understand and solve real problems."
    }
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl font-bold mb-6 leading-tight">
              Meet the <span className="bg-gradient-to-r from-blue-600 via-sky-500 to-blue-700 bg-clip-text text-transparent">Minds</span> Behind Smart Learning
            </h1>
                ...
                <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-2 hover:border-blue-500/30 overflow-hidden">
                  <CardContent className="p-0">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm font-medium text-sky-600 mb-3">{member.role}</p>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <a href="mailto:careers@smartlearning.com">
                View Open Positions
              </a>
            </Button>
          </motion.div>
