  ...
  const features = [
    {
      ...
      description: "AI-powered paper generation with templates, automated creation, and intelligent question selection. Transform exam paper creation from hours to seconds while maintaining academic standards.",
    ...
    },
    {
      ...
      description: "Complete student lifecycle management with SMS/WhatsApp notifications and customizable portals. Connect with students and parents through modern communication channels.",
    ...
    },
    {
      ...
      description: "Modern attendance management with real-time tracking, analytics, and automated reporting. Never miss a beat with biometric integration and instant alerts.",
    ...
    },
    {
      ...
      description: "Comprehensive result processing, analytics, and automated report card generation. Track student performance and generate insights with powerful analytics tools.",
      href: "#",
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-muted">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          ...
          >
            ...
            >
              Modernize your institution with our fully digital, AI-powered education management system. 
              From one-click paper generation to intelligent student management.
            </motion.p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-4">
              Powerful <span className="bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">Modules</span>
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Join hundreds of schools and institutions already using Smart Learning
            </p>
