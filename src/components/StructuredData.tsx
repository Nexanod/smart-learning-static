export default function StructuredData() {
  const organizationSchema = {
    ...
    "@type": "Organization",
    "name": "Smart Learning",
    "description": "Modern education management system with AI-powered paper generation, student management, and attendance tracking.",
  ...
  const softwareSchema = {
    ...
    "description": "AI-powered education management platform for modern institutions"
  };
