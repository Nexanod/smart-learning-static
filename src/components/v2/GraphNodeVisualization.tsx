  ...
  const modules = [
    {
      ...
      description: "Transform your exam creation process with AI-powered paper generation. Create comprehensive, well-structured exam papers in seconds.",
      features: [
    ...
    },
    {
      ...
      description: "Manage your entire student database with intelligent automation. From enrollment to graduation, track every detail seamlessly.",
      features: [
    ...
    },
    {
      ...
      description: "Let AI handle repetitive tasks while you focus on teaching. Get intelligent recommendations and automated workflows.",
      features: [
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
                ...
                >
                  <div className="bg-card/90 backdrop-blur-xl border border-border rounded-3xl p-8 shadow-2xl">
                    <div className="flex items-start gap-4 mb-6">
                      <div className={`bg-gradient-to-br ${module.gradient} rounded-2xl p-4 shadow-lg`}>
                        <Icon className="w-8 h-8 text-white" />
                      </div>
                      <div className="flex-1">
                        <h3 className="text-3xl font-bold mb-1">{module.title}</h3>
                        <p className={`text-sm font-medium bg-gradient-to-r ${module.gradient} bg-clip-text text-transparent`}>
                          {module.tagline}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <h4 className="text-sm font-semibold text-foreground/60 uppercase tracking-wider">Key Features</h4>
                      {module.features.map((feature, i) => (
                        ...
                        >
                          <CheckCircle2 className={`w-5 h-5 mt-0.5 text-transparent bg-gradient-to-r ${module.gradient} bg-clip-text flex-shrink-0`} />
                ...
                <div className="relative w-1/2 h-[600px] flex items-center justify-center">
                  ...
                  <div className="absolute top-[55%] w-full flex justify-between items-start px-4">
                    {modules.map((mod, idx) => {
                      ...
                      const positions = ['left-[10%]', 'left-[45%]', 'left-[80%]'];
                      ...
                      return (
                        ...
                        >
                          <div className={`bg-gradient-to-br ${mod.gradient} backdrop-blur-xl border-2 ${isConnected ? 'border-white/50' : 'border-white/20'} rounded-2xl p-6 shadow-xl transition-all duration-300 z-20`}>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10">
        <p className="text-xs text-muted-foreground">Scroll to explore modules</p>
