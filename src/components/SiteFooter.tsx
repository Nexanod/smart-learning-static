  ...
  },
  {
    ...
    icon: (
      <svg width='18' height='18' viewBox='0 0 192 192' fill='currentColor'>
        ...
        <path fill='none' stroke='currentColor' strokeWidth='12' strokeLinecap='round' d='M120 138.001s-8 6-24 6-24-6-24-6' />
        <circle cx='146' cy='36.001' r='12' fill='none' stroke='currentColor' strokeWidth='12' />
